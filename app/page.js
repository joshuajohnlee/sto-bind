...
import './styles/lcars-ultra-classic.css'
      ...
      <section className="wrap-standard" id="column-3">
        <div className="wrap">
          ...
          <div className="left-frame-top">
            <div className="panel-1"><a href="">LCARS</a></div>
            <div className="panel-2">02<span className="hop">-262000</span></div>
          </div>
          <div className="right-frame-top">
            <div className="banner"> <a href="">LCARS</a> &#149; <span className="blink">Online</span> </div>
        ...
        <div className="wrap" id="gap">
          ...
          <div className="right-frame">
            ...
            <main>
              ...
              <h2>Welcome to LCARS <span className="go-tomato">Ultra</span> &#149; classNameic Theme &#149;<br />
                Standard Layout</h2>
              ...
              <footer>
                <div className="footer-inside">
                  <div className="footer-text">
                    ...
                    <p> Content Copyright &#169; 2023 *replace this text with your site's name or url*
                    </p>
